...
var ErrFieldIsEmpty = errors.New("Some fields are empty")
...
type APIResponse struct {
	...
	Data    interface{ any } `json:"data,omitempty"`
...
func NewMessage(id int, username, content string) *Message {
	...
	msg := Message{ID: id, Username: username, Content: content, Timestamp: time.Now()}
	return &msg
}
...
func (r *CreateMessageRequest) Validate() error {
	...
	if len(r.Content) == 0 || len(r.Username) == 0 {
